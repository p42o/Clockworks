---
title: "How to Use Claude to Write All Your Business Emails in Half the Time"
date: "2026-05-11"
description: "The setup takes 15 minutes. After that, you'll wonder how you wrote emails without it."
legacyPath: "/blog/claude-for-email.html"
...
## The setup: Claude account + a Project
...
> The Project setup is the highest-leverage 15 minutes you'll spend this week. Do it once, and every email you write from then on will require 50% less explanation in your prompt.
...
For when you sent a quote 3–5 days ago and haven't heard back.

```
Write a short follow-up email to a customer who received a quote from me on [day/date] and hasn't responded. I quoted them [brief description of the job, e.g. "a new HVAC system install" or "a full backyard renovation"]. The amount was approximately $[X]. Keep it under 80 words, friendly, not pushy. End by asking if they have any questions or if the timing needs to shift.
```
...
### The New Lead Response

For responding to someone who filled out a form or reached out cold.

```
Write a reply to a new inquiry from someone who [describe what they're asking about, e.g. "wants a quote on repiping their basement" or "is interested in selling their home"]. They came through [form / referral / Instagram]. I want to confirm I received their message, show I understand what they need, and propose a next step (a call or site visit). Keep it warm, under 100 words.
```

**Template 04**

### The Check-In After Service

For following up after you've completed a job, to check in and (gently) ask for a review.

```
Write a short follow-up email to a customer I completed work for about [X] days ago. The job was [brief description]. I want to check in, make sure they're happy, and mention that a Google review would mean a lot to us without being aggressive about it. Friendly and genuine, under 100 words.
```

**Template 05**

### The Vendor / Partner Email
